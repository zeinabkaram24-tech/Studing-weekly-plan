  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-indigo-950 via-slate-900 to-indigo-900 p-4 sm:p-5 rounded-3xl text-white shadow-md flex flex-wrap items-center justify-between gap-4 border border-indigo-800/40">
        ...
        {/* Action Buttons: Class Selector, Timetable, Weekdays Planner, and Upload Files */}
        <div className="flex flex-wrap items-center gap-2.5">
          {/* Class Section Switcher Buttons */}
          <div className="flex items-center bg-slate-950/80 p-1 rounded-2xl border border-indigo-800/60 shadow-inner">
            <span className="text-[11px] font-bold text-indigo-300 px-2 flex items-center gap-1">
              <School className="w-3.5 h-3.5 text-indigo-400" />
              <span className="hidden sm:inline">الفصل:</span>
            </span>
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-2xl text-xs font-bold bg-white text-indigo-950 hover:bg-indigo-50 shadow-sm transition-all duration-150 flex items-center gap-2 font-sans active:scale-95"
            title={`الضغط لعرض الجدول الدراسي لفصل ${selectedSection}`}
          >
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-2xl text-xs font-bold bg-purple-600 hover:bg-purple-500 text-white shadow-sm transition-all duration-150 flex items-center gap-2 font-sans active:scale-95"
            title="الضغط لعرض كل أيام الأسبوع والمخطط الكامل"
          >
